...
<body>
    ...
    <script>
        ...
        const displayPokemon = async () => {
            ...
            pokemon_img.src = pokemonApi.info['pokemon-img'];
            const pokemon_id = document.getElementById('pokemon_id');
            pokemon_id.innerHTML = pokemonApi.info['pokemon']['id'];
            const pokemon_name = document.getElementById('pokemon_name');
            pokemon_name.innerHTML = pokemonApi.info['pokemon-species']['names'][0]['name'];
        };
    </script>
    <!-- JSライブラリ -->
